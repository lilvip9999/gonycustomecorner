#
#  Be sure to run `pod spec lint GonyCustomeCorner.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "This control can developer custome corder easier"

  spec.homepage     = "https://github.com/lilvip9999/gonycustomecorner"
  ...
  spec.source       = { :git => "https://github.com/lilvip9999/gonycustomecorner.git", :tag => "#{spec.version}" }
